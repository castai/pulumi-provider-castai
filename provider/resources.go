...
import (
	...
	castai "github.com/castai/terraform-provider-castai/provider" // Import the upstream provider
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-castai/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-castai/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "castai", castai.Provider(),
		...
		// convention is to have a function at "github.com/castai/terraform-provider-castai/provider".New
		...
		//
		//nolint:lll
		P: shimv2.NewProvider(castai.New(version.Version)()),
		...
		PluginDownloadURL: "",
		Description:       "A Pulumi package for creating and managing castai cloud resources.",
		...
		Golang: &tfbridge.GolangInfo{
			...
			ImportBasePath: path.Join(
				"github.com/castai/pulumi-castai/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("castai_", mainMod,
